...
[InitializeOnLoad()]
public class HumanoidWaypointEditor
{
    [DrawGizmo(GizmoType.NonSelected|GizmoType.Selected|GizmoType.Pickable)]
    public static void OnDrawSceneGizmo(WaypointHumanoid waypoint, GizmoType gizmosType)
    {
        if((gizmosType & GizmoType.Selected) != 0)
        {
